                  ...
                  <form onSubmit={submitLoginHandler} className="myform">
                     <table className="loginTable" >
                        ...
                        <tr className="loginItem" >
                           <td >
                              <input className="form__input" type="email" name="userLogin" placeholder="Username" value={userLogin} required onChange={(e) => changeLoginHandler(e)} ></input>
                           </td>
                        </tr>
                        <tr className="loginItem">
                           <td >
                              <input className="form__input" type="password" placeholder="Password" name="passwdLogin" value={passwdLogin} required onChange={(e) => changeLoginHandler(e)}></input>
                           </td>
                        </tr>
                        <tr className="loginItem">
                           <td>
                              <select className="form__input__role" name="roleLogin" value={roleLogin} required onChange={(e) => changeLoginHandler(e)} >
